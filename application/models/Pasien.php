...
class Pasien extends CI_Model {
    ...
    public function daftar() {
        ...
        $sql = "INSERT INTO pasien VALUES (NULL, '". $_POST['nik'] ."', '". $_POST['nama_kk'] ."', '". $_POST['nama'] ."', '". $_POST['tanggal_lahir'] ."', '". $_POST['alamat'] ."', '". $_POST['jenis_kelamin'] ."', '". $_POST['pekerjaan'] ."', '". $_POST['agama'] ."', '". $_POST['no_hp'] ."', '". $_POST['umur'] ."', '". $_POST['email'] ."');";
        $this->db->query($sql);
